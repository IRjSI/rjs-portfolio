...
const AudioPlayer = () => {
    ...
    return (
        <StyledWrapper className="fixed bottom-0 right-0 md:bottom-6 md:right-6 z-50 scale-[0.4] sm:scale-50 md:scale-75 origin-bottom-right pointer-events-none">
            <audio
                ref={audioRef}
                src="/prot.wav"
                loop
                preload="auto"
            />
            <div className="relative flex items-center justify-center w-[200px] h-[200px] pointer-events-auto">
